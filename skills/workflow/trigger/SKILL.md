...
Memicu workflow dari event.

## Kapan Digunakan

- Perlu menjalankan operasi konkret dalam domain **Workflow / Automation**.
...
- Webhook, file-change, message, timer.
- Validasi payload trigger.
- Idempoten terhadap duplicate event.
