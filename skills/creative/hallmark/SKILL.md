---
name: hallmark
description: "Anti-AI-slop design skill (full Nutlope/hallmark upstream). Greenfield pages, audit, redesign, study DNA. Triggers: hallmark, anti slop, anti-ai-slop, no AI slop, landing page, redesign, frontend design, portfolio site, UI design, bikin website."
version: 1.1.0
source: https://github.com/Nutlope/hallmark
license: MIT
tags: [design, anti-slop, frontend, hallmark, website, ui]
related_skills: [anti-ai-slop-design, vercel-single-file-site, website-security-hardening, accessibility-a11y, performance-core-web-vitals, seo-meta-tags]
---

> **Hermes install:** full upstream tree under `references/`.  
> Pipeline: `hallmark` → BUILD → `website-security-hardening` → DEPLOY (`vercel-single-file-site` when single-file).  
> Upstream: https://github.com/Nutlope/hallmark · demo https://www.usehallmark.com · MIT.
...
**Mobile is the canonical build target.** Implement base styles at `320px` and browser-verify `320/375/414` before desktop work. Use content-driven `min-width` enhancements only. Touch targets are at least `48px`; no hover-only essential interaction; wide tables redesign to cards; navigation collapses instead of wrapping; desktop is never the baseline.
