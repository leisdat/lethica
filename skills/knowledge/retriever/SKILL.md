...
Mengambil konteks relevan dari knowledge base.
...
- Gunakan similarity + metadata filter.
- Batas top-k untuk menjaga konteks relevan.
- Berikan citation (source path) pada hasil.
