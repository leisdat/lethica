...
Pipeline retrieve-augmented generation.
...
- Retrieve → Compose context → Generate → Cite
- Jangan jawab di luar konteks yang di-retrieve.
- Nyatakan ketidakpastian jika retrieval kosong.
