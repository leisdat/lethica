...
Penyimpanan sementara hasil komputasi.

## Kapan Digunakan

- Perlu menjalankan operasi konkret dalam domain **State / Cache**.
...
- Key berdasar input hash.
- TTL & invalidation jelas.
- Hindari cache poisoning.
